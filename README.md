...
**Case study:** <https://aces-redesign.vercel.app/case-study.html> — the argument behind it: ten
findings measured on the live site, the IA rework, the design system, and a rubric map. Runs the
real site inside a phone frame.
...
- `scripts/check.js` — the deploy gate, 23 assertions.
